...
public final class ReverseStringCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(ReverseStringCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    ReverseString command = new ReverseString();
