...
public final class StringNotStartsWithCondition implements Condition {
  private static final Logger logger = LogManager.getLogger(StringNotStartsWithCondition.class);
  ...
  public boolean test(GlobalSessionContext globalSessionContext, Map<String, Value> parameters,
    ...
    StringNotStartsWith command = new StringNotStartsWith();
