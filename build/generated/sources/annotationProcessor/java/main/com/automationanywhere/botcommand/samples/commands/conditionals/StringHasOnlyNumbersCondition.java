...
public final class StringHasOnlyNumbersCondition implements Condition {
  private static final Logger logger = LogManager.getLogger(StringHasOnlyNumbersCondition.class);
  ...
  public boolean test(GlobalSessionContext globalSessionContext, Map<String, Value> parameters,
    ...
    StringHasOnlyNumbers command = new StringHasOnlyNumbers();
    ...
    try {
      boolean result = command.validate((String)convertedParameters.get("value"));
