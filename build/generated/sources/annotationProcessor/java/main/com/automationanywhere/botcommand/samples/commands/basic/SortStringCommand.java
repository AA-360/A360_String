...
public final class SortStringCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(SortStringCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    SortString command = new SortString();
