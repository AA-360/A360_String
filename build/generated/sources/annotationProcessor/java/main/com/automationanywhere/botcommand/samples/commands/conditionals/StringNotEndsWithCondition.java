...
public final class StringNotEndsWithCondition implements Condition {
  private static final Logger logger = LogManager.getLogger(StringNotEndsWithCondition.class);
  ...
  public boolean test(GlobalSessionContext globalSessionContext, Map<String, Value> parameters,
    ...
    StringNotEndsWith command = new StringNotEndsWith();
