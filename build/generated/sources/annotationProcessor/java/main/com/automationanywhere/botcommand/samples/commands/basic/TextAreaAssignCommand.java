...
public final class TextAreaAssignCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(TextAreaAssignCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    TextAreaAssign command = new TextAreaAssign();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("value")));
